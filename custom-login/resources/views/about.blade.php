...
<section class="bg-white dark:bg-gray-900 background-image-container1">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">"Empowering Choices, Trusted Solutions"</h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Welcome to our website, where you'll discover the finest laptops to meet all your needs. Here, we're more than just a laptop store; we're your trusted companion on your tech journey.</p>
      </div>
...
<section class="bg-white dark:bg-gray-900 background-image-container2">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Team</h2>
          <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Our team is a dynamic blend of talents dedicated to delivering excellence in every project.
Driven by collaboration and innovation, we work together to achieve remarkable results.</p>
      </div> 
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                  <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Mai Chi Kha</a>
                  </h3>
                  <span class="text-gray-500 dark:text-gray-400">Hacker</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Everything will terminate. Choose your own road and do not give up</p>
                  <ul class="flex space-x-4 sm:mt-0">
                      <li>
                          <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
